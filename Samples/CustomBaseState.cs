...
namespace Samples
{
    ...
    {
        protected override bool CanTransition(IEvent @event, CustomBaseState to, object eventData)
        {
        ...
        protected override CustomBaseState HandleEvent(IEvent @event, object eventData)
        {
